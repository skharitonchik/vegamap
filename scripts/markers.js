...
let MARKERS = [{
    ...
    geo: [{
        latitude: 53.93096,
        longitude: 27.65360,
        address: 'ул. Кирилла Туровского, 24 (цокольный этаж)',
        timeOfWork: 'ПН-ВС 9:30-22:00',
        phones: ['+375 (44) 758-70-80'],
    }],
    links: ['https://www.instagram.com/pilligreen.by', 'https://pilligreen.by/']
}];
//endregion
